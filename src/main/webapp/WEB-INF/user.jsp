...
<div class = "container">
	...
	<p>${errors}</p>
 	<div class="row">
		<div class= "col p-5">	
			<form  class="border border-success px-3 pt-2" action = "/login" method = "POST">
			<h2>Login</h2>
			<hr>
	...
	<div class= "col p-5">	
		<form:form  class="border border-success px-3 pt-2" action="/loginToRegister" method="post" modelAttribute="user">
		<h2>Register</h2>
		<hr>
	    <div class="form-group row ">
